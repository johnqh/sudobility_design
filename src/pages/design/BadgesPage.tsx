  ...
  return (
    <>
      ...
      <div className="text-center mb-12">
        ...
        <h1 className={`${textVariants.heading.display.xl()} mb-6`}>Badge Components</h1>
        ...
        <p className={`${textVariants.body.lg()} max-w-3xl mx-auto text-muted-foreground mb-8`}>
          ...
          with semantic colors and interactive states.
        </p>

        {/* Badge Stats */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto">
          <div className={`${ui.background.subtle} rounded-lg p-4`}>
            <div className={`${textVariants.heading.h4()} text-accent mb-1`}>8</div>
            <div className={textVariants.caption.default()}>Badge Variants</div>
          </div>
          <div className={`${ui.background.subtle} rounded-lg p-4`}>
          ...
          <div className={`${ui.background.subtle} rounded-lg p-4`}>
            <div className={`${textVariants.heading.h4()} text-primary mb-1`}>5</div>
            <div className={textVariants.caption.default()}>State Types</div>
          </div>
          <div className={`${ui.background.subtle} rounded-lg p-4`}>
            <div className={`${textVariants.heading.h4()} text-secondary mb-1`}>4</div>
            <div className={textVariants.caption.default()}>Web3 Variants</div>
          </div>
        </div>
      </div>
      ...
      <div className={`${variants.card.elevated.padded()} mb-12`}>
        ...
        {expandedSections['quick-start'] && (
          <div className="space-y-8">
            {/* Basic Badges */}
            <div>
              <h3 className={`${textVariants.heading.h3()} mb-4`}>1. Essential Badge Types</h3>
            ...
            <div>
              <h3 className={`${textVariants.heading.h3()} mb-4`}>2. Status Badges with Icons</h3>
              <div className="bg-muted p-6 rounded-lg mb-4">
                <div className="flex flex-wrap gap-3 items-center">
            ...
            {/* Size Variants */}
            <div>
              <h3 className={`${textVariants.heading.h3()} mb-4`}>3. Size Variations</h3>
              <div className="bg-muted p-6 rounded-lg mb-4">
                <div className="flex flex-wrap gap-3 items-center">
                  <span className={variants.badge.small('primary')}>Small</span>
                  <span className={variants.badge.primary()}>Default</span>
                  <span className={variants.badge.large('primary')}>Large</span>
                </div>
              </div>
              <CodeBlock filename="internal/badges/sizes.tsx" title="Badge Sizes" />
            </div>

            {/* Web3 Badges */}
            <div>
              <h3 className={`${textVariants.heading.h3()} mb-4`}>4. Web3 Integration Badges</h3>
              <div className="bg-muted p-6 rounded-lg mb-4">
                <div className="flex flex-wrap gap-3 items-center">
              ...
              <CodeBlock filename="internal/badges/web3-variants.tsx" title="Web3 Badge Variants" />
            </div>
          </div>
        )}
      </div>
        ...
        {expandedSections['variants'] && (
          <div className="space-y-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Semantic Variants */}
              <div>
                <h3 className={`${textVariants.heading.h4()} mb-4`}>Semantic Colors</h3>
              ...
              {/* Web3 Variants */}
              <div>
                <h3 className={`${textVariants.heading.h4()} mb-4`}>Web3 Specific</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <div className="bg-muted p-4 rounded-lg mb-3">
                  <span className={variants.badge.small('primary')}>Small Badge</span>
                </div>
                <p className="text-sm text-muted-foreground">Compact size for dense layouts</p>
              </div>

              <div className="text-center">
                <h4 className={`${textVariants.heading.h5()} mb-3`}>Default</h4>
                <div className="bg-muted p-4 rounded-lg mb-3">
                  <span className={variants.badge.primary()}>Default Badge</span>
                </div>
                <p className="text-sm text-muted-foreground">Standard size for most use cases</p>
              </div>

              <div className="text-center">
                <h4 className={`${textVariants.heading.h5()} mb-3`}>Large</h4>
                <div className="bg-muted p-4 rounded-lg mb-3">
                  <span className={variants.badge.large('primary')}>Large Badge</span>
                </div>
                <p className="text-sm text-muted-foreground">Prominent size for emphasis</p>
              </div>
            </div>

            <CodeBlock filename="internal/badges/size-variants.tsx" title="Size Variants" />
          </div>
        )}
      </div>
      ...
      <div className={`${variants.card.elevated.padded()} mb-12`}>
        ...
        {expandedSections['interactive'] && (
          <div className="space-y-8">
            {/* User Status Example */}
            <div>
              <h3 className={`${textVariants.heading.h4()} mb-4`}>User Status Indicators</h3>
              <div className="bg-muted p-6 rounded-lg mb-4">
                <div className="space-y-4">
            ...
            {/* Notification Badges */}
            <div>
              <h3 className={`${textVariants.heading.h4()} mb-4`}>Notification Counts</h3>
              <div className="bg-muted p-6 rounded-lg mb-4">
                <div className="flex flex-wrap gap-6">
                  <div className="relative">
                    <button className="p-3 bg-card rounded-lg border">📧 Messages</button>
                  ...
                  <div className="relative">
                    <button className="p-3 bg-card rounded-lg border">🔔 Notifications</button>
                  ...
                  <div className="relative">
                    <button className="p-3 bg-card rounded-lg border">⭐ Updates</button>
      ...
      <div className={`${variants.card.elevated.padded()} mb-12`}>
        ...
        {expandedSections['accessibility'] && (
          <div className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start">
                    <CheckCircleIcon className="h-5 w-5 text-success mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-sm">Provide adequate color contrast (4.5:1 minimum)</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircleIcon className="h-5 w-5 text-success mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-sm">Include text labels, not just colors or icons</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircleIcon className="h-5 w-5 text-success mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-sm">Use appropriate ARIA labels for screen readers</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircleIcon className="h-5 w-5 text-success mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-sm">Keep badge text concise and meaningful</span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span className="text-sm">Relying solely on color to convey information</span>
                  </li>
                  <li className="flex items-start">
                    <XCircleIcon className="h-5 w-5 text-destructive mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-sm">Using too many badges in a single interface</span>
                  </li>
                  <li className="flex items-start">
                    <XCircleIcon className="h-5 w-5 text-destructive mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-sm">Making badges too small to read comfortably</span>
                  </li>
                  <li className="flex items-start">
                    <XCircleIcon className="h-5 w-5 text-destructive mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-sm">Using unclear or ambiguous badge text</span>
                  </li>
                  <li className="flex items-start">
                    <XCircleIcon className="h-5 w-5 text-destructive mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-sm">Overusing animated or flashing badges</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="mt-8">
              <h3 className={`${textVariants.heading.h4()} mb-4`}>ARIA Examples</h3>
              <CodeBlock
