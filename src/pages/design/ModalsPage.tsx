        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="mb-12">
            <div className="inline-flex items-center bg-accent/10 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-accent font-semibold">Modals & Dialogs</span>
            </div>

            <h1 className={`${textVariants.heading.display.xl()} mb-6`}>Modal Components</h1>

            <p className={`${textVariants.body.lg()} max-w-3xl text-muted-foreground`}>
              Comprehensive modal and dialog system with Web3 integration patterns, accessibility
              features, and responsive behavior. Perfect for wallet connections, transaction
              confirmations, and user interactions.
            </p>
          </div>
          ...
          {/* Interactive Demos */}
          <Section>
            <h2 className={`${textVariants.heading.h2()} mb-8`}>Interactive Demos</h2>
          ...
          {/* Size Variants */}
          <Section>
            <h2 className={`${textVariants.heading.h2()} mb-8`}>Size Variants</h2>

            <div
              className={`${ui.background.surface} ${ui.border.default} border rounded-lg overflow-hidden`}
            >
              <div className="p-6 border-b border-border">
                <h3 className={`${textVariants.heading.h3()} mb-4`}>Available Sizes</h3>
                ...
                {sizeVariants.map((variant, index) => (
                  <div key={index} className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        <h4 className={`${textVariants.heading.h4()} mb-1`}>{variant.name}</h4>
                        <code
                      ...
                      <button
                        onClick={() =>
                          copyToClipboard(`variants.modal.container.${variant.value}()`)
                        }
          ...
          <Section>
            <h2 className={`${textVariants.heading.h2()} mb-8`}>Web3 Integration Patterns</h2>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className={`${ui.background.surface} ${ui.border.default} border rounded-lg`}>
                <div className="p-6 border-b border-border">
                  <h3 className={`${textVariants.heading.h3()} mb-2`}>Wallet Connection Flow</h3>
                  <p className={`${textVariants.body.sm()} text-muted-foreground`}>
                    Complete wallet connection experience with provider selection.
                  </p>
                </div>
                <div className="p-6">
  ...
  <div className={variants.modal.web3.wallet()}>
    ...
    <div className={variants.modal.content.default()}>
      <WalletProviderList />
              ...
              <div className={`${ui.background.surface} ${ui.border.default} border rounded-lg`}>
                <div className="p-6 border-b border-border">
                  <h3 className={`${textVariants.heading.h3()} mb-2`}>Transaction Confirmation</h3>
                  <p className={`${textVariants.body.sm()} text-muted-foreground`}>
          ...
          <Section>
            ...
            <div className={`${ui.background.surface} ${ui.border.default} border rounded-lg`}>
              <div className="p-6 border-b border-border">
                ...
                <p className={`${textVariants.body.md()} text-muted-foreground`}>
                  Follow these guidelines to ensure your modals are accessible to all users.
                </p>
              </div>
...
>
  <div className={variants.modal.container.medium()}>
    ...
    <p id="modal-description">Modal description text</p>
                  ...
                  <div>
                    <h4 className={`${textVariants.heading.h4()} mb-3`}>Focus Management</h4>
                    <ul className="space-y-2 text-muted-foreground">
                      <li className="flex items-start gap-2">
                        <CheckCircleIcon className="h-5 w-5 text-success flex-shrink-0 mt-0.5" />
                        <span>
                          Focus should move to the first focusable element in the modal when opened
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircleIcon className="h-5 w-5 text-success flex-shrink-0 mt-0.5" />
                        <span>Tab navigation should be trapped within the modal</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircleIcon className="h-5 w-5 text-success flex-shrink-0 mt-0.5" />
                        <span>Focus should return to the trigger element when modal is closed</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircleIcon className="h-5 w-5 text-success flex-shrink-0 mt-0.5" />
                  ...
                  <div>
                    <h4 className={`${textVariants.heading.h4()} mb-3`}>Screen Reader Support</h4>
                    <ul className="space-y-2 text-muted-foreground">
                      <li className="flex items-start gap-2">
                        <InformationCircleIcon className="h-5 w-5 text-info flex-shrink-0 mt-0.5" />
                        <span>Use semantic HTML elements (button, form, etc.)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <InformationCircleIcon className="h-5 w-5 text-info flex-shrink-0 mt-0.5" />
                      ...
                      <li className="flex items-start gap-2">
                        <InformationCircleIcon className="h-5 w-5 text-info flex-shrink-0 mt-0.5" />
                        <span>Announce modal state changes with live regions</span>
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <Section>
            ...
            <div className={`${ui.background.subtle} rounded-xl p-8`}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <h3 className={`${textVariants.heading.h3()} mb-4`}>React Portal Usage</h3>
                  <p className={`${textVariants.body.md()} text-muted-foreground mb-4`}>
                    Render modals in a portal to avoid z-index issues and ensure proper layering.
                  </p>
...
const Modal = ({ children, isOpen }) => {
  ...
  return createPortal(
    ...
    document.body
                ...
                <div>
                  <h3 className={`${textVariants.heading.h3()} mb-4`}>Animation Considerations</h3>
                  <p className={`${textVariants.body.md()} text-muted-foreground mb-4`}>
                    Use CSS animations or libraries like Framer Motion for smooth modal transitions.
                  </p>
                  <ul className="space-y-2 text-muted-foreground">
      ...
      {demoState.simpleModal && (
        <div className={variants.modal.overlay.default()} onClick={() => closeModal('simpleModal')}>
          <div className={variants.modal.container.medium()} onClick={e => e.stopPropagation()}>
            <div className={variants.modal.header.default()}>
              <h3 className={textVariants.heading.h3()}>Simple Modal Example</h3>
              <button
            ...
            <div className={variants.modal.content.default()}>
              <p className={textVariants.body.md()}>
                This is a basic modal with standard header, content, and footer sections. It
                demonstrates the typical modal structure and styling.
              </p>
              <p className={`${textVariants.body.sm()} text-muted-foreground mt-3`}>
                Click outside the modal or press the close button to dismiss it.
              </p>
            </div>
            <div className={variants.modal.footer.default()}>
              <Button variant="outline" onClick={() => closeModal('simpleModal')}>
                Cancel
              </Button>
      ...
      {demoState.confirmationModal && (
        ...
        >
          <div className={variants.modal.container.small()} onClick={e => e.stopPropagation()}>
            <div className={variants.modal.content.padded()}>
              <div className="flex items-center gap-3 mb-4">
                <ExclamationTriangleIcon className="h-6 w-6 text-warning" />
            ...
            <div className={variants.modal.footer.default()}>
              <Button variant="outline" onClick={() => closeModal('confirmationModal')}>
                Cancel
              </Button>
              <Button variant="destructive" onClick={() => closeModal('confirmationModal')}>
                Delete
              </Button>
            </div>
          </div>
      ...
      {demoState.walletModal && (
        <div className={variants.modal.overlay.default()} onClick={() => closeModal('walletModal')}>
          <div className={variants.modal.web3.wallet()} onClick={e => e.stopPropagation()}>
            <div className={variants.modal.header.default()}>
              <h3 className={textVariants.heading.h3()}>Connect Wallet</h3>
              <button
                className={variants.modal.close.default()}
              ...
              <div className="space-y-3">
                <button className="w-full flex items-center gap-3 p-3 border border-border rounded-lg hover:bg-muted transition-colors">
                  ...
                  <div className="text-left">
                    ...
                    <div className={`${textVariants.caption.default()} text-muted-foreground`}>
                ...
                <button className="w-full flex items-center gap-3 p-3 border border-border rounded-lg hover:bg-muted transition-colors">
                  ...
                  <div className="text-left">
                    <div className={textVariants.heading.h5()}>WalletConnect</div>
                    <div className={`${textVariants.caption.default()} text-muted-foreground`}>
            ...
            <div className={variants.modal.content.padded()}>
              <div className="text-center">
                <div className="mb-6">
                  ...
                  {transactionState === 'pending' && <Spinner size="large" className="mx-auto" />}
                ...
                <p className={`${textVariants.body.md()} text-muted-foreground mb-6`}>
                  ...
                  {transactionState === 'confirming' && 'Waiting for blockchain confirmation...'}
                  {transactionState === 'success' &&
                  ...
                  <div className="space-y-4 mb-6">
                    <div className="bg-muted rounded-lg p-4">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className={`${textVariants.body.sm()} font-medium`}>0.5 ETH</span>
                      </div>
                      <div className="flex justify-between items-center mb-2">
                        <span className={textVariants.body.sm()}>Gas Fee:</span>
                        <span className={`${textVariants.body.sm()} font-medium`}>~$12.50</span>
                      </div>
                      <div className="flex justify-between items-center border-t pt-2 mt-2">
                        <span className={textVariants.body.sm()}>Total:</span>
                        <span className={`${textVariants.body.md()} font-semibold`}>
                          ~0.5045 ETH
                        </span>
                      </div>
                    </div>
                ...
                <div className="flex gap-3 justify-center">
                  {transactionState === 'idle' && (
                    <>
                      <Button variant="outline" onClick={() => closeModal('transactionModal')}>
                        Cancel
                      </Button>
      ...
      {demoState.formModal && (
        <div className={variants.modal.overlay.default()} onClick={() => closeModal('formModal')}>
          <div className={variants.modal.container.large()} onClick={e => e.stopPropagation()}>
            <div className={variants.modal.header.default()}>
            ...
            <div className={variants.modal.content.default()}>
              <form className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className={`${textVariants.body.sm()} block mb-2`}>First Name</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className={`${textVariants.body.sm()} block mb-2`}>Last Name</label>
                    <input
                      type="text"
                      className="w-full px-3 py-2 border border-input rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-ring"
                ...
                <div>
                  <label className={`${textVariants.body.sm()} block mb-2`}>Email Address</label>
                  <input
                    type="email"
                    className="w-full px-3 py-2 border border-input rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-ring"
                ...
                <div>
                  <label className={`${textVariants.body.sm()} block mb-2`}>Message</label>
                  <textarea
                    rows={4}
                    className="w-full px-3 py-2 border border-input rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-ring"
            ...
            <div className={variants.modal.footer.default()}>
              ...
              <Button onClick={() => closeModal('formModal')}>Send Message</Button>
            </div>
          </div>
        </div>
      )}
      ...
      {demoState.settingsModal && (
        ...
        >
          <div className={variants.modal.container.extraLarge()} onClick={e => e.stopPropagation()}>
            <div className={variants.modal.header.default()}>
              <h3 className={textVariants.heading.h3()}>Settings & Preferences</h3>
              <button
                className={variants.modal.close.default()}
                onClick={() => closeModal('settingsModal')}
              >
            ...
            <div className={variants.modal.content.scrollable()}>
              <div className="space-y-8">
                <div>
                  <h4 className={`${textVariants.heading.h4()} mb-4`}>Account Settings</h4>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <div className={textVariants.body.md()}>Email Notifications</div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <div className={textVariants.body.md()}>Two-Factor Authentication</div>
                        <div className={`${textVariants.body.sm()} text-muted-foreground`}>
                ...
                <div>
                  <h4 className={`${textVariants.heading.h4()} mb-4`}>Privacy Settings</h4>
                  <div className="space-y-4">
                    <div>
                    ...
                    <div>
                      <label className={`${textVariants.body.sm()} block mb-2`}>Data Sharing</label>
                ...
                <div>
                  <h4 className={`${textVariants.heading.h4()} mb-4`}>Appearance</h4>
                  <div className="space-y-4">
                    <div>
                      <label className={`${textVariants.body.sm()} block mb-2`}>Theme</label>
            ...
            <div className={variants.modal.footer.spaceBetween()}>
              <Button variant="outline" onClick={() => closeModal('settingsModal')}>
                Reset to Defaults
              </Button>
              <div className="flex gap-3">
                ...
                <Button onClick={() => closeModal('settingsModal')}>Save Changes</Button>
              </div>
            </div>
          </div>
        </div>
