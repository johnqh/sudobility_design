...
const ButtonsPage: React.FC<AppProps> = ({ emailDomain, appName: _appName }) => {
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center bg-accent px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-accent-foreground font-semibold">Button Components</span>
            </div>
            ...
            <p className={`${textVariants.body.lg()} max-w-3xl mx-auto text-muted-foreground`}>
              Comprehensive button component system with consistent variants, sizes, states, and
              interactive behaviors. All buttons support loading states, proper focus management,
          ...
          <Section>
            <div className="bg-accent/10 rounded-xl p-8 border border-accent/20">
              ...
              <p className={`${textVariants.body.md()} text-muted-foreground mb-8`}>
                Ready-to-use button components with consistent styling, states, and behavior
                patterns.
              </p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  <h3 className={`${textVariants.heading.h4()} mb-3`}>Primary Action Button</h3>
                ...
                {/* Secondary Button */}
                <div className="space-y-4">
                  <h3 className={`${textVariants.heading.h4()} mb-3`}>Secondary Button</h3>
                  <div className="bg-muted rounded-lg p-4 relative">
                    <button
                      className="absolute top-2 right-2 p-1 hover:bg-accent rounded"
                ...
                {/* Outline Button */}
                <div className="space-y-4">
                  <h3 className={`${textVariants.heading.h4()} mb-3`}>Outline Button</h3>
                  <div className="bg-muted rounded-lg p-4 relative">
                    <button
                      className="absolute top-2 right-2 p-1 hover:bg-accent rounded"
                  ...
                  <div className="p-4 bg-card rounded-lg border border-border">
                    <button className={variants.button.outline.default()}>Outline Action</button>
                  </div>
                </div>

                {/* Ghost Button */}
                <div className="space-y-4">
                  <h3 className={`${textVariants.heading.h4()} mb-3`}>Ghost Button</h3>
                  <div className="bg-muted rounded-lg p-4 relative">
                    <button
                      className="absolute top-2 right-2 p-1 hover:bg-accent rounded"
                    ...
                    <pre className="text-sm text-foreground overflow-x-auto">{ghostQuickStart}</pre>
                  </div>
                  <div className="p-4 bg-card rounded-lg border border-border">
                    <button className={variants.button.ghost.default()}>Ghost Action</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Button Variants */}
          <Section>
            <h2 className={`${textVariants.heading.h2()} mb-8`}>Button Variants</h2>
            <p className={`${textVariants.body.md()} text-muted-foreground mb-8`}>
              Different button styles for various use cases and hierarchy levels.
            </p>
...
// → each resolves to bg-primary text-primary-foreground at the matching size`}
          ...
          {/* Button States */}
          <Section>
            <h2 className={`${textVariants.heading.h2()} mb-8`}>Button States</h2>
            <p className={`${textVariants.body.md()} text-muted-foreground mb-8`}>
              Interactive states including hover, active, focus, loading, and disabled.
            </p>
...
<button disabled className={variants.button.primary.default()}>Disabled</button>`}
                preview={
                  <div className="flex flex-wrap gap-3">
                    ...
                    <button disabled className={variants.button.primary.default()}>
                      Disabled
                    </button>
                  </div>
                }
          ...
          {/* Icon Buttons */}
          <Section>
            <h2 className={`${textVariants.heading.h2()} mb-8`}>Icon Buttons & Combinations</h2>
            <p className={`${textVariants.body.md()} text-muted-foreground mb-8`}>
              Buttons with icons, icon-only buttons, and toggle buttons for enhanced usability.
            </p>
...
<button className={variants.button.destructive.default()}>
  ...
  <span>Delete</span>
          ...
          {/* Button Groups */}
          <Section>
            <h2 className={`${textVariants.heading.h2()} mb-8`}>Button Groups & Combinations</h2>
            <p className={`${textVariants.body.md()} text-muted-foreground mb-8`}>
              Grouped buttons, button bars, and action combinations for complex interfaces.
            </p>
...
<div className="flex flex-wrap gap-2">
  ...
  <button className={variants.button.ghost.default()}>Cancel</button>
                ...
                preview={
                  <div className="space-y-4">
                    <div>
                      <p className="text-sm text-muted-foreground mb-2">Connected Group:</p>
                      <div className="inline-flex rounded-lg shadow-sm" role="group">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground mb-2">Spaced Group:</p>
                      <div className="flex flex-wrap gap-2">
                        <button className={variants.button.primary.default()}>Primary</button>
                        <button className={variants.button.secondary.default()}>Secondary</button>
                        <button className={variants.button.ghost.default()}>Cancel</button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <ul className="space-y-2 text-foreground">
                  <li className="flex items-start">
                    ...
                    <span>
                      Use semantic <code className="bg-info/10 text-info px-1 rounded">button</code>{' '}
                  ...
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-info rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Add loading states to prevent double submissions</span>
                  </li>
                </ul>
                <ul className="space-y-2 text-foreground">
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-info rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Use appropriate ARIA labels for icon-only buttons</span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-info rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Maintain minimum touch target size (44px x 44px)</span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-info rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  ...
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-info rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Group related buttons logically with proper spacing</span>
                  </li>
                </ul>
              </div>
            </div>
