    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          >
            Comprehensive design system documentation showcasing all colors,
            typography, and design tokens used throughout the {appName}.
          </p>
        ...
        <div className={`${ui.background.subtle} rounded-xl p-8`}>
          ...
          <p className={`${textVariants.body.md()} text-muted-foreground mb-6`}>
            The {appName} is built with consistency, scalability, and
            accessibility in mind. It provides a comprehensive set of design
